...
describe('index.js', () => {
	...
	describe('tailsNeverFails()', () => {         //expects Math.random, but expects specific returns from it? tests also loop infinitely/crash despite code working properly in other settings
		let spy;
